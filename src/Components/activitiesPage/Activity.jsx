...
function Activity(props) {
  ...
  const activityClass = props.activity.applied
  ...
  const applyHandlerFalse = () => {
    props.cencel(props.activity.id);
  };
  ...
  const openCloseDetailed = () => {
    setDetailed((prevState) => !prevState);
  };
  ...
  return (
    <>
      ...
      {detailed && !customizing && (
        <Detailed
          saveChanges={saveChangesHandler}
          close={openCloseDetailed}
          activity={props.activity}
        />
      )}
      <div className={activityClass} onClick={openCloseDetailed}>
        ...
        <div className={classes.buttons}>
          ...
          {/* cencel the application to the activity */}
          {props.activity.applied && (
            // <Button type="green" onClick={applyHandler} label={"Apply"} />

            <button className={classes.btn} onClick={applyHandlerFalse}>
              <p className={classes.paragraph}> Cencel </p>
              <span className={classes.iconWrapper}>
                <svg className={classes.icon} width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
